<div class=" min-h-screen">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
            ...
            <span class="self-center whitespace-nowrap">Breukh’S Cool</span>
          </a>
  ...
  <div class="flex overflow-hidden bg-white pt-16 min-h-screen">
        ...
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div class="flex-1 px-3 bg-white divide-y space-y-1">
            <ul class="space-y-2 pb-2">
              ...
              <li>
                <a href="/admin/home" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg fill="currentColor" class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
              ...
              <li>
                <a href="/admin/student" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg fill="currentColor" class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                  ...
                  <span class="ml-3">Élevés</span>
                </a>
              </li>
              <li>
                <a href="/admin/schoolLevel" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg fill="currentColor" class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                  ...
                  <span class="ml-3">Niveaux Scolaires</span>
                </a>
              </li>
              <li>
                <a href="/admin/schoolYear" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg fill="currentColor" class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                  ...
                  <span class="ml-3">Année Scolaires</span>
                </a>
              </li>
              <li>
                <a href="/admin/classroom" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg fill="currentColor" class="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            ...
            <div class="space-y-2 pt-2">
              <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <div id="main-content" class="flex flex-col w-full bg-gray-50 lg:ml-64">
      <main class=" flex-auto">
        <?= $content ?>
      </main>
      <footer class="text-center text-sm text-gray-500 my-10">
        &copy; 2022-2023 <a href="#" class="hover:underline" target="_blank">Breukh’S Cool</a>. All rights reserved.
      </footer>
    </div>
  </div>
</div>