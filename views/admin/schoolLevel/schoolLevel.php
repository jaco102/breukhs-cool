<div class="container mx-auto px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl font-semibold leading-tight">Niveau Scolaires</h2>
    </div>
    <div class="my-2 flex sm:flex-row flex-col">
      ...
      <div class="ml-6">
        <a href="/admin/schoolLevel/add" class="shadow bg-blue-400 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
          Ajouter
        </a>
      </div>
    </div>
          ...
          <tbody>
            <?php foreach ($schoolLevels as $schoolLevel) : ?>
              <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <p class="text-gray-900 whitespace-no-wrap">
                    <?= $schoolLevel->createdAt ?>
                  </p>
                </td>
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                  <p class="text-gray-900 whitespace-no-wrap">
                    <?= $schoolLevel->updatedAt ?>
                  </p>
                </td>
              </tr>
            <?php endforeach ?>
