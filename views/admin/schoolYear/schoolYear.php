<div class="container mx-auto px-4 sm:px-8">
  <div class="py-8">
    <div>
      <h2 class="text-2xl font-semibold leading-tight">Années Scolaires</h2>
    </div>
    <div class="my-2 flex sm:flex-row flex-col">
      ...
      <div class="ml-6">
        <a href="/admin/schoolYear/add" class="shadow bg-blue-400 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
          Ajouter
        </a>
      </div>
    </div>
